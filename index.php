      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="add-user-form" class="p-2" novalidate>
            ...
            <div class="mb-3">
              <input type="course" name="course" class="form-control form-control-lg" placeholder="Enter course" required>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="edit-user-form" class="p-2" novalidate>
            ...
            <div class="mb-3">
              <input type="course" name="course" id="course" class="form-control form-control-lg" placeholder="Enter course" required>
              <div class="invalid-feedback">course is required!</div>
            </div>
